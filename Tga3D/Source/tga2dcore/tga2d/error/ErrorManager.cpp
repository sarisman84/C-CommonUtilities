...
void Tga2D::ErrorManager::AddLogListener(callback_function_log aFunctionToCall, callback_function_error aFunctionToCallOnError)
{
	if (aFunctionToCall)
	{
...
void Tga2D::ErrorManager::ErrorPrint(const char* aFile, int aline, const char* aFormat, ...)
{
...
void Tga2D::ErrorManager::InfoPrint( const char* aFormat, ... )
{
...
void Tga2D::ErrorManager::InfoTip(const char* aFormat, ...)
{
...
void Tga2D::ErrorManager::SetConsoleColor(int aColor)
{
	HANDLE  hConsole;
