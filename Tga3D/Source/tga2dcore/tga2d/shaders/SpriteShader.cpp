...
Tga2D::SpriteShader::SpriteShader()
...
bool Tga2D::SpriteShader::Init(const wchar_t* aVertex, const wchar_t* aPixel)
{
...
void Tga2D::SpriteShader::SetDataBufferIndex(ShaderDataBufferIndex aBufferRegisterIndex)
{
	myBufferIndex = (unsigned char)aBufferRegisterIndex;
}

void Tga2D::SpriteShader::SetShaderdataFloat4(Tga2D::Vector4f someData, ShaderDataID aID)
{
...
void Tga2D::SpriteShader::SetTextureAtRegister(Tga2D::TextureResource* aTexture, ShaderTextureSlot aRegisterIndex)
{
...
bool Tga2D::SpriteShader::PrepareRender(const SpriteSharedData& aSharedData)
{
...
bool Tga2D::SpriteShader::CreateInputLayout(const std::string& aVS)
{
