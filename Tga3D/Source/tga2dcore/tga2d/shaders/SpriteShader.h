...
namespace Tga2D
{
	...
	public:
		...
		void SetShaderdataFloat4(Tga2D::Vector4f someData, ShaderDataID aID);
		...
		void SetTextureAtRegister(Tga2D::TextureResource* aTexture, ShaderTextureSlot aRegisterIndex);
	...
	private:
		...
		{
			BoundTexture() {}
			BoundTexture(Tga2D::TextureResource* aTex, unsigned char aIndex)
			{
				myTexture = aTex;
				myIndex = aIndex;
			}
