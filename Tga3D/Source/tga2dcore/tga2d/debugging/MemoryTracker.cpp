...
#include <tga2d/debugging/StackTrace.h>
#include <algorithm>
#include <array>
#include <mutex>
...
void Tga2D::StartMemoryTracking(const MemoryTrackingSettings& trackingSettings)
{
...
void Tga2D::StopMemoryTrackingAndPrint()
{
	...
	else
	{
		...
		else
		{
			...
			OutputDebugStringA("== when calling Tga2D::Engine::GetInstance()->Start(...)\n");
			OutputDebugStringA("================================================================================\n");
		}
	}
...
void Tga2D::StartMemoryTracking(const MemoryTrackingSettings&) {}
void Tga2D::StopMemoryTrackingAndPrint() {}
