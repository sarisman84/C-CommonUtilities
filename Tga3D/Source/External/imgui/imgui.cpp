...
/*
 ...
 - 2019/12/08 (1.75) - removed redirecting functions/enums that were marked obsolete in 1.53 (December 2017):
                       ...
                       - GetItemLineHeightWithSpacing()     -> use GetFrameHeightWithSpacing()
 ...
 - 2017/12/13 (1.53) - renamed GetItemLineHeightWithSpacing() to GetFrameHeightWithSpacing(). Kept redirection function (will obsolete).
...
ImGuiWindowSettings* ImGui::FindOrCreatWindowSettings(const char* name)
{
...
void ImGui::DockBuilderCopyWindowSettings(const char* src_name, const char* dst_name)
{
    ...
    else if (ImGuiWindowSettings* dst_settings = FindOrCreatWindowSettings(dst_name))
    {
