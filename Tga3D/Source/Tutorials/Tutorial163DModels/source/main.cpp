...
void Go(void)
{
...

    {
        ...
        Tga2D::AnimatedModelInstance animatedModel = modelFactory.GetAnimatedModel(L"../source/tutorials/Tutorial163DModels/data/CH_NPC_Undead_17G3_SK.fbx");
        animatedModel.SetLocation({ 0.0f, 100.0f, 0.0f });

        std::vector<std::wstring> animations;
        animations.push_back(L"../source/tutorials/Tutorial163DModels/data/CH_NPC_Undead@Idle_01_17G3_AN.fbx");
        animations.push_back(L"../source/tutorials/Tutorial163DModels/data/CH_NPC_Undead@Walk_01_17G3_AN.fbx");

        animatedModel.InitAnimations(animations);
        ...
        while (bShouldRun)
        {
            ...
            animatedModel.SetCurrentAnimationIndex(0);
            animatedModel.Update(timer.GetDeltaTime());
